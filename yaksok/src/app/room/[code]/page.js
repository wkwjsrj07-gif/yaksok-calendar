        ...
        <div style={{flex:'1 1 500px',background:'#fff',borderRadius:16,padding:24,boxShadow:'0 1px 3px rgba(0,0,0,0.06)'}}>
              ...
              return (
                <div key={i} onClick={() => ds && st !== 'past' && st !== 'empty' && handleDateClick(ds)}
                  ...
                  {num && <>
                    ...
                    {myTime && <span style={{fontSize:9,color:'#fff',marginTop:1,fontWeight:600}}>{TIME_LABELS_SHORT[myTime]}</span>}
          ...
          <div style={{display:'flex',gap:16,marginTop:16,justifyContent:'center',flexWrap:'wrap'}}>
            <span style={{display:'flex',alignItems:'center',gap:6,fontSize:12,color:'#64748b'}}>
              <span style={{width:10,height:10,borderRadius:'50%',background:'#22c55e',display:'inline-block'}}/> 내가 가능
            </span>
            <span style={{display:'flex',alignItems:'center',gap:6,fontSize:12,color:'#64748b'}}>
              <span style={{width:16,height:16,borderRadius:'50%',background:'#22c55e',color:'#fff',display:'flex',alignItems:'center',justifyContent:'center',fontSize:9,fontWeight:700}}>n</span> 가능한 인원 수
            </span>
            <span style={{display:'flex',alignItems:'center',gap:6,fontSize:12,color:'#64748b'}}>
              <span style={{width:10,height:10,borderRadius:'50%',background:'#fee2e2',display:'inline-block',border:'1px solid #fecaca'}}/> 안 됨/미정
            </span>
            <span style={{display:'flex',alignItems:'center',gap:6,fontSize:12,color:'#64748b'}}>
              <span style={{width:10,height:10,borderRadius:'50%',background:'#e2e8f0',display:'inline-block'}}/> 지난 날
            </span>
          </div>
